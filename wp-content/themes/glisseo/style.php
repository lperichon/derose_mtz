...
.logo {
	position: absolute;
	background-color: <?php echo $tb_themeoptions["tb_glisseo_header_logo_background_color"]; ?>;
	border-bottom: 5px solid <?php echo $tb_themeoptions["tb_glisseo_header_logo_background_border_color"]; ?>;
